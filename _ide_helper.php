...
namespace Livewire {
    ...
    class Livewire {
         ...
         * @static
         */
        public static function addComponent($name, $path = null, $class = null)
        {
            /** @var \Livewire\LivewireManager $instance */
            return $instance->addComponent($name, $path, $class);
        }

        /**
         * @static
         */
        public static function addNamespace($namespace, $path = null, $class = null)
        {
            /** @var \Livewire\LivewireManager $instance */
            return $instance->addNamespace($namespace, $path, $class);
        }

        /**
         * @static
         */
        public static function addLocation($path = null, $class = null)
        {
            /** @var \Livewire\LivewireManager $instance */
            return $instance->addLocation($path, $class);
        }
